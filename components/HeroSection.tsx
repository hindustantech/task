...
//               <h1 className="text-[20px] md:text-[60px] font-bold text-[#3bc191] uppercase tracking-wide whitespace-nowrap">
//                 HIRE DEDICATED
//               </h1>
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-white">
            <div className="flex items-center gap-4">
              <h1 className="text-[24px] sm:text-[40px] md:text-4xl font-bold text-[#3bc191] uppercase whitespace-nowrap tracking-wide">
                HIRE DEDICATED
              </h1>
              <div className="   flex-1 border-t-2 border-[#3bc191]"></div>
            </div>

            <h2 className="text-[32px] sm:text-[50px] md:text-[60px] font-extrabold text-[#1a2e35] leading-tight mt-2">
              DEVELOPERS
            </h2>
            <p className="text-[#1a2e35] text-[16px] sm:text-[18px] font-semibold mt-2">
              Top 1% Pre-Vetted, In-House & Dedicated Software Programmers
            </p>
            <p className="text-sm text-[#1a2e35] mt-4 leading-relaxed">
              Lorem Ipsum Is Simply Dummy Text Of The Printing And Typesetting Industry. Lorem Ipsum Has Been The Industry's Standard Dummy
              Text Ever Since The 1500s, When An Unknown Printer Took A Galley Of Type And Scrambled
            </p>

            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-6">
              <Button className="bg-[#FF7F7F] hover:bg-[#ff6a6a] text-white rounded-md px-6 py-3 text-sm font-semibold w-full sm:w-auto">
                View More ↗
              </Button>
              <Button
                variant="outline"
                className="border-[#2DC67D] text-[#2DC67D] rounded-md px-6 py-3 text-sm font-semibold w-full sm:w-auto"
              >
                Get In Touch ↗
              </Button>
            </div>
